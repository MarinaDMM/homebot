...
def parse(text: str) -> tuple[str, str, str]:
    ...
    try:
        ...
        # Strip date-y words so the reminder text reads cleanly.
        rest = re.sub(r"\s+", " ",
